...
export const finalizeCheckoutForm = async (ctx) => {
   ...
   ctx.reply("Delivery: for free", Markup.inlineKeyboard(
      [
        [Markup.button.callback(CONFIG.LOCALES.order.confirm, CONFIG.LOCALES.order.confirm)],
        [Markup.button.callback(CONFIG.LOCALES.order.cancel, CONFIG.LOCALES.order.cancel)],
      ]
    ))
  }
